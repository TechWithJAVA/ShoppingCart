package com.yash.shopping.constants;
...
public class ResponseCode {
	...
	public static final String ADD_SUCCESS_MESSAGE = "ADD_PRODUCT";
	public static final String UPD_SUCCESS_MESSAGE = "UPDATE_PRODUCT";
	public static final String DEL_SUCCESS_MESSAGE = "DELETE_PRODUCT";
	public static final String VIEW_SUCCESS_MESSAGE = "VW_ORD";
	public static final String UPD_ORD_SUCCESS_MESSAGE = "UPD_ORD";
	public static final String LIST_SUCCESS_MESSAGE = "LIST_OF_PRODUCT";
	...
	public static final String INVALID_PHONE_NO_FAIL_MSG = "INVALID_MOBILE_NO";
